...
export default function Hero() {
  ...
  const closeModal = ()=>{
    ...
    const medicineData = [
        ...
        {
            name:'Medicine 1',
            image:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQX64dUXwnzgQ7YQwXl9QT2E17iHMJvhQmdwg&usqp=CAU',
            description:'Celine madawa'
        }
        , {
          name:'Medicine 1',
  ...
  return (
    <div>
        ...
        <section  style={{ overflowX: 'hidden' }} className='w-full  '>
            <MedicineCouresel  medicineData={medicineData} handleButtonClick={handleButtonClick}/>
        </section>
        {/* section to show modal*/}
        {showAddToCartModal &&<AddToCart  closeModal={closeModal}/>}
